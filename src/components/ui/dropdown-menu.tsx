...
const DropdownMenuSubTrigger = ({ className, inset, children, ...props }: DropdownMenuPrimitive.MenuSubTriggerProps & {
  inset?: boolean
}) => (
...
const DropdownMenuItem = ({ className, inset, ...props }:DropdownMenuPrimitive.MenuItemProps & {
  inset?: boolean
}) => (
...
const DropdownMenuLabel = ({ className, inset, ...props }: DropdownMenuPrimitive.DropdownMenuLabelProps& {
  inset?: boolean
}) => (
